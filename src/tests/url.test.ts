...
describe("joinPaths", () => {
  it("handles no trailing/leading slashes", () => {
    expect(joinPaths("http://example.com/app", "path")).toBe(
...
describe("httpToWs", () => {
  ...
  it("clears query parameters", () => {
    expect(httpToWs("http://example.com/app?foo=bar&baz=qux")).toBe(
      "ws://example.com/app",
    )
  })
...
describe("clearQueryParams", () => {
  it("removes query string", () => {
    expect(clearQueryParams("http://example.com/app?foo=bar")).toBe(
      "http://example.com/app",
    )
  })
  it("preserves URL without query string", () => {
    expect(clearQueryParams("http://example.com/app")).toBe(
      "http://example.com/app",
    )
  })
  it("preserves hash", () => {
    expect(clearQueryParams("http://example.com/app?foo=bar#section")).toBe(
      "http://example.com/app#section",
    )
  })
})
...
describe("appendPath", () => {
  it("appends a relative path to a base URL", () => {
    expect(appendPath("http://example.com/app", "api/data")).toBe(
      "http://example.com/app/api/data",
    )
  })
